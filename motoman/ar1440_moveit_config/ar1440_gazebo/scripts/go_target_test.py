...
#                           [0, 0, 0, 1                                       ]])
    ...
    pose_goal.position.x =  result_1[0][3]         #- 0.402794
    pose_goal.position.y =  result_1[1][3]         #- 0.002158351 
    pose_goal.position.z =  result_1[2][3]+0.1  #- 0.450 #+ 0.156928  #+450 : 팬던트 상에서는 450mm가 더해져서 나오기때문에 코드상에서는 더해줘야함.
