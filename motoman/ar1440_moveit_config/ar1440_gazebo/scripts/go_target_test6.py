...
######################################################################################
    ...
    pose_goal.position.z =  result_1[2][3] + 0.1         #+0.1  #- 0.450 #+ 0.156928  #+450 : 팬던트 상에서는 450mm가 더해져서 나오기때문에 코드상에서는 더해줘야함.
######################################################################################
...
######################################################################################
    ...
    goal2_result = tutorial.plan_execute_pose_goal(goal2)
    print("goal2's result :",goal2_result)
    if not goal2_result:
...
######################################################################################
    ...
    goal3.position.z = r3[2][3] + 0.1
######################################################################################
    print(goal3.position.x)
    print(goal3.position.y)
    print(goal3.position.z)

    goal3_result = tutorial.plan_execute_pose_goal(goal3)
    print("goal3's result :",goal3_result)
    if not goal3_result:
