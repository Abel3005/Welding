...
class MoveArm(object):
  ...
  def go_to_pose_goal(self):
    ...
    # base -> end-effector transformation matrix               # end-effector translation
    current_p = np.array([[ 0.3753989,  0.0007699,  0.9268630, current_pose.position.x],
                          [ 0.0009996, -0.9999994,  0.0004258, current_pose.position.y],
                          [ 0.9268628,  0.0007667, -0.3753995, current_pose.position.z],
                          [ 0,          0,          0,         1                      ]])

    # end-effector -> camera transformation matrix
    ...
    #e_p_array1 = np.array([[0.0042092690  , -0.9994275,   0.0335694900, Save_yolo_poses.poses[0].pose.position.z],
    #                       [-0.5539359634 , -0.0302790,  -0.8320084543, Save_yolo_poses.poses[0].pose.position.y],
    #                       [0.8325486466  , -0.0150931,  -0.5537463389, Save_yolo_poses.poses[0].pose.position.x],
    #                       [0, 0, 0, 1                                                                  ]])
    ...
    #                       [0, 0, 0, 1                                       ]])
    #e_p_array3 = np.array([[0.0042092690  , -0.9994275,   0.0335694900, Save_yolo_poses.poses[2].pose.position.z],
    #                       [-0.5539359634 , -0.0302790,  -0.8320084543, Save_yolo_poses.poses[2].pose.position.y],
    #                       [0.8325486466  , -0.0150931,  -0.5537463389, Save_yolo_poses.poses[2].pose.position.x],
    #                       [0, 0, 0, 1                                       ]])
    ...
    pose_goal.position.x = 0.388387 # 0.627422   #result_1[0][3]         #- 0.402794
    pose_goal.position.y = -0.030 # -0.020059    #result_1[1][3]         #- 0.002158351 
    pose_goal.position.z = 0.351343 + 0.450  # 0.217790 + 0.450  #result_1[2][3] + 0.25#- 0.450 #+ 0.156928  #+450 : 팬던트 상에서는 450mm가 더해져서 나오기때문에 코드상에서는 더해줘야함.

    # 2번 인덱스 위치(확인용)
    #test1 =  result_2[0][3]#- 0.402794
    #test2 =  result_2[1][3]#- 0.002158351
    #test3 =  result_2[2][3]-0.450#+ 0.156928
    
    # 3번 인덱스 위치(확인용)
    #test4 =  result_3[0][3]#- 0.402794
    #test5 =  result_3[1][3]#- 0.002158351
    #test6 =  result_3[2][3]-0.450#+ 0.156928
